...
const LORE_ENTITIES: LoreEntityData[] = [
  // 9 Đỉnh (from lore.md §10.5)
  { id: "metal-cauldron", ten: "Kim Đỉnh", kind: "cauldron", era: "dai-dan-dao", status: "shattered", identity: "Đỉnh thượng cổ #1. Tinh luyện mặt Kim của thiên địa. Rèn bởi đan sư thứ nhất.", story: "Vỡ sau Cửu Chuyển thất bại 800 năm trước. Hiện nằm rải rác tại Kim region (Cửu Tiêu, sky temples). Trấn giữ bởi atlas super-boss." },
  { id: "wood-cauldron", ten: "Mộc Đỉnh", kind: "cauldron", era: "dai-dan-dao", status: "shattered", identity: "Đỉnh thượng cổ #2. Tinh luyện mặt Mộc của thiên địa. Rèn bởi đan sư thứ hai.", story: "Vỡ sau Cửu Chuyển thất bại. Hiện nằm tại Mộc region (bamboo valleys)." },
  { id: "water-cauldron", ten: "Thuỷ Đỉnh", kind: "cauldron", era: "dai-dan-dao", status: "shattered", identity: "Đỉnh thượng cổ #3. Tinh luyện mặt Thuỷ của thiên địa. Rèn bởi đan sư thứ ba.", story: "Vỡ sau Cửu Chuyển thất bại. Hiện nằm tại Thuỷ region (Long Cung, underwater)." },
  { id: "fire-cauldron", ten: "Hoả Đỉnh", kind: "cauldron", era: "dai-dan-dao", status: "shattered", identity: "Đỉnh thượng cổ #4. Tinh luyện mặt Hoả của thiên địa. Rèn bởi đan sư thứ tư.", story: "Vỡ sau Cửu Chuyển thất bại. Hiện nằm tại Hoả region (volcanic chains)." },
  { id: "earth-cauldron", ten: "Thổ Đỉnh", kind: "cauldron", era: "dai-dan-dao", status: "shattered", identity: "Đỉnh thượng cổ #5. Tinh luyện mặt Thổ của thiên địa. Rèn bởi đan sư thứ năm.", story: "Vỡ sau Cửu Chuyển thất bại. Hiện nằm tại Thổ region (burial mounds)." },
  { id: "void-cauldron", ten: "Vô Cực Đỉnh", kind: "cauldron", era: "dai-dan-dao", status: "shattered", identity: "Đỉnh thượng cổ #6. Trung tâm Ngũ Hành. Rèn bởi đan sư thứ sáu.", story: "Vỡ sau Cửu Chuyển thất bại. Hiện nằm tại Vô Cực Đỉnh peak (cosmic)." },
  { id: "heart-demon-cauldron", ten: "Tâm Ma Đỉnh", kind: "cauldron", era: "dai-dan-dao", status: "shattered", identity: "Đỉnh thượng cổ #7. Tâm Ma reversal. Rèn bởi đan sư thứ bảy (corrupted).", story: "Vỡ sau Cửu Chuyển thất bại. Hiện nằm tại Diêm Phủ (underworld). Đan sư rèn nó bị corrupted trong quá trình luyện." },
  { id: "heavenly-tribulation-cauldron", ten: "Thiên Kiếp Đỉnh", kind: "cauldron", era: "dai-dan-dao", status: "shattered", identity: "Đỉnh thượng cổ #8. Thiên Kiếp absorption. Rèn bởi Cao Tổ.", story: "Vỡ sau Cửu Chuyển thất bại. Hiện bị phong ấn tại Hồn Nguyên Điện cùng Hỗn Nguyên Tâm Ma Vương." },
  { id: "neutral-cauldron", ten: "Đỉnh Trung Lập", kind: "cauldron", era: "dai-dan-dao", status: "active", identity: "Đỉnh thượng cổ #9. Linh hồn / Vô. Rèn bởi Lò Thần để giữ linh hồn pháp trận.", story: "Đỉnh duy nhất sống sót sau Cửu Chuyển thất bại, nhưng nứt thành 8 mảnh nội tại (= 8 slot equipment của Lò player). Player's Lò tổ truyền chính là đỉnh này. Acts 1-3: phục hồi 8 mảnh. Atlas endgame: dùng Sơn Hà Đồ Lệnh tìm 8 đỉnh còn lại." },
  // Key artifacts (from lore.md §10.1-10.4)
  { id: "ancestral-furnace", ten: "Lò Luyện Đan Tổ Truyền", kind: "artifact", era: "dai-dan-dao", status: "active", identity: "Player's Lò. Forged by Lò Thần 4000 years ago. Used by Cao Tổ to seal Hỗn Nguyên Tâm Ma Vương.", story: "Broken into 8 pieces during The Sundering (~500 years ago). 1 piece restored each Act 3 onwards. Full restoration = Act 5 prerequisite. The Lò is the Neutral Cauldron (Đỉnh Trung Lập)." },
  ...
  { id: "furnace-spirit-origin", ten: "Lò Thần (Linh Hồn Thợ Rèn)", kind: "spirit", era: "dai-dan-dao", status: "active", identity: "Spirit bound to the Lò tổ truyền. Was a mortal smith who died forging the first Lò 4000 years ago. Soul fused with the Lò.", story: "Appears as NPC (furnace-spirit) whenever Lò needs major repair/upgrade. Rèn ra Đỉnh Trung Lập — đỉnh thứ 9 trong Cửu Đỉnh. Linh hồn ông là cầu nối giữa vật chất (Lò) và tinh thần (linh đan)." },
