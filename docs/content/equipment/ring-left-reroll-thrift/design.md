---
id: ring-left-reroll-thrift
ten: Đồ Sương Reroll Tiết Kiệm (Trái)
slot: ringL
rarity: Common
variant: Phàm
isUnique: false
...
# Đồ Sương Reroll Tiết Kiệm (Trái) (`ring-left-reroll-thrift`)

## Lược tả

Nhẫn sương bạch ngọc đơn giản — không rực rỡ nhưng hữu dụng. Linh lực trong nhẫn tự động làm nhẹ gánh chi phí mỗi lần đạo sĩ thử lại affix, dần tích lũy thành khoản tiết kiệm đáng kể qua nhiều pháp trận. Nhẫn trái phải cùng khắc rãnh tiết kiệm đối xứng.
...
**Đồ Sương (ringL)** — nhẫn sương trái trong Lò Luyện Đan. Đồ Sương là slot **intensity + crit** (combat-math §3-4): mỗi Đồ Sương trang bị +10% intensity; variant cụ thể quyết định utility phụ. Reroll Tiết Kiệm hướng utility vào **gambling economy** — phù hợp build đầu tư nhiều vào trụ reroll affix. Mirror pair với `ring-right-reroll-thrift` — đeo cả hai = +20% intensity + -20% reroll cost.
...
- **Thay thế**: khi build đã đủ tài nguyên và chuyển sang cần crit/intensity cao hơn, thay bằng `ring-left-seal-safety` (Legendary) hoặc `ring-left-spirit-record` (Unique).
