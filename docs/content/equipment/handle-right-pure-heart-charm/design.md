---
id: handle-right-pure-heart-charm
ten: Quai Tịnh Tâm Phù (Phải)
slot: handleR
rarity: Rare
variant: Bảo
isUnique: false
...
# Quai Tịnh Tâm Phù (Phải) (`handle-right-pure-heart-charm`)

## Lược tả

Phù lệnh khắc chữ "Tịnh" bằng mực linh thần — mỗi khi Tâm Ma xâm nhập, phù tự bùng sáng xua sạch ô nhiễm khỏi linh đan trong nháy mắt. Quai phải và trái cùng khắc một phù ký, cùng chung một lời thề thanh tịnh.
...
**Quai (handleR)** — tay cầm phải Lò Luyện Đan. Cặp Quai L/R là lớp phòng thủ utility của Lò: không tăng sát thương, chuyên cung cấp hiệu ứng hoạt động (active) 1×/ván dạng cứu nguy hoặc hỗ trợ chain. Quai trái và phải là **mirror pair** — hiệu ứng giống hệt nhau, chỉ khác side lắp; trang bị cả hai tức đeo **2 charge** cùng loại hiệu ứng.

## Build use

- **Anti-Tâm Ma core**: trang bị cả `handle-left-pure-heart-charm` + `handle-right-pure-heart-charm` → 2 charge/ván xoá Tâm Ma. Thiết yếu cho bí cảnh variant **Tâm Ma** và tier T6-T13 nơi boss Tâm Ma xâm nhập liên tục.
