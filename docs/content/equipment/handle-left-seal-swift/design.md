---
id: handle-left-seal-swift
ten: Quai Phong Ấn Tốc (Trái)
slot: handleL
rarity: Common
variant: Phàm
isUnique: false
...
# Quai Phong Ấn Tốc (Trái) (`handle-left-seal-swift`)

## Lược tả

Quai đồng thô giản, khắc rãnh chữ "Tốc" — đủ để dẫn linh lực kích hoạt một Phong Ấn miễn phí mỗi ván. Không có gì hào nhoáng, chỉ có hiệu quả thực dụng của người luyện đan tính toán tiết kiệm từng đồng đan dược. Quai trái phải đối xứng, cùng rãnh khắc, cùng công năng.
...
**Quai (handleL)** — tay cầm trái Lò Luyện Đan. Quai utility tier thấp nhất: hiệu ứng Phong Ấn nhanh phù hợp giai đoạn đầu game khi đan dược khan hiếm. Mirror pair với `handle-right-seal-swift` — đeo cả hai = 2 lần Phong Ấn miễn phí/ván.
...
- **Thay thế khi nâng cấp**: Common sẽ được thay bằng `handle-left-thunderbolt-charm` (Legendary) hoặc `handle-left-wuxing-array` (Unique) khi vào atlas — giữ slot seal cho utility cao hơn.
