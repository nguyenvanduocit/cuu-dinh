---
id: handle-right-thunderbolt-charm
ten: Quai Lôi Đình Phù (Phải)
slot: handleR
rarity: Legendary
variant: Thần
isUnique: false
...
# Quai Lôi Đình Phù (Phải) (`handle-right-thunderbolt-charm`)

## Lược tả

Phù lệnh cổ đại mang sấm sét của Thiên Kiếp — một lần mỗi ván, đạo sĩ có thể gọi xuống một tia sét thần uy, xé ngang trung tâm board, phá vỡ sự cân bằng tích lũy của linh khí địch. Quai phải trái cùng mang sấm âm dương, đối xứng như hai cực của thiên lôi.
...
**Quai (handleR)** — tay cầm phải Lò Luyện Đan. Quai tier Legendary: chuyển từ utility phòng thủ sang tấn công chủ động. Mirror pair với `handle-left-thunderbolt-charm` — đeo cả hai = 2 tia sét/ván, khai thác tối đa timing linh hoạt.
...
- **Combo `ring-left-spirit-record`**: lưu affix Lôi từ linh khí Legendary → map sau guaranteed spawn linh khí Lôi Legendary → sét kế thừa charge từ chain Lôi dài.
- **Anti-synergy**: bí cảnh variant **Long Cung** có linh khí đồng minh — sét AoE không phân biệt địch/đồng minh, có thể vô tình phá linh khí của mình.
