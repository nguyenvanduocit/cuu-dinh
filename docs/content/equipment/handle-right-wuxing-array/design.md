---
id: handle-right-wuxing-array
ten: Ngũ Hành Trận (Phải)
slot: handleR
rarity: Unique
variant: Cổ vật
isUnique: true
...
# Ngũ Hành Trận (Phải) (`handle-right-wuxing-array`)

## Lược tả

Cổ vật Quai hiếm nhất — không phải phù lệnh đơn thuần mà là một pháp trận thu nhỏ khắc trên thân quai. Mỗi ván kích hoạt triệu hồi nguyên thần của một trong Ngũ Hành, hiện hình thành linh khí trên board. Quai phải trái cùng mang pháp trận đối xứng — một cặp triệu hồi Kim Mộc Thủy Hỏa Thổ.
...
- Linh khí triệu hồi xuất hiện tại tọa độ tâm board, rarity **Magic** mặc định, không có affix — blank slate.
- Linh khí triệu hồi **tồn tại suốt ván** (không bị xoá sau mỗi wave), nhưng có thể bị phá huỷ nếu bị damage quá mức.
- Không thể triệu hồi nguyên tố trùng với linh đan đang luyện trong cùng ván.
...
**Quai (handleR)** — tay cầm phải Lò Luyện Đan. Quai Unique duy nhất: không phải cứu nguy hay economy, mà là **board manipulation** — chủ động tạo ra linh khí mới thay vì chỉ phản ứng với board hiện tại. Mirror pair với `handle-left-wuxing-array` — đeo cả hai = 2 linh khí triệu hồi/ván (2 nguyên tố khác nhau, ngẫu nhiên).
...
- **Đánh đổi**: nguyên tố ngẫu nhiên không kiểm soát được — có thể ra nguyên tố tương khắc với linh đan đang luyện.
