---
id: handle-left-revive-charm
ten: Quai Hồi Sinh Phù (Trái)
slot: handleL
rarity: Magic
variant: Linh
isUnique: false
...
# Quai Hồi Sinh Phù (Trái) (`handle-left-revive-charm`)

## Lược tả

Phù lệnh ấm áp màu hổ phách — linh khí vừa tan vỡ chưa kịp tắt linh tính đã bị phù níu lại, kéo về với đủ sức sống để tiếp tục tham chiến. Quai trái và phải cùng khắc một phù ký hồi sinh, đối xứng như đôi cánh tay nâng đỡ.
...
**Quai (handleL)** — tay cầm trái Lò Luyện Đan. Quai L/R cặp đôi utility: không tăng sát thương trực tiếp, chuyên cứu tình huống nguy cấp trong ván. Mirror pair với `handle-right-revive-charm` — cùng hiệu ứng, đeo cả hai = 2 charge hồi sinh/ván.
...
- **Đạo Phái Linh Sơn**: echo system của Linh Sơn tạo ra nhiều linh khí clone — hồi sinh linh khí gốc (không phải clone) giữ nguyên buff chain gốc, clone vẫn còn.
