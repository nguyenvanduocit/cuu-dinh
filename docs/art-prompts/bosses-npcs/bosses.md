...
> `art-direction.md:164-168`: dark tím triều base, smoky aura, human-shaped silhouette with horrific mask.
...
> `art-direction.md:170-174`: no body — only lightning; sky near-black; golden lightning bolts.
