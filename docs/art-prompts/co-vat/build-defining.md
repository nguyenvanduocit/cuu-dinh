...
Cổ vật = hero art. Rarity treatment luôn là "intense prismatic rainbow particle storm, shifting iridescent aura, legendary radiance". Tất cả 10 mục category này có element=void — bỏ element token.
...
### `thousand-mile-scythe` — Lưỡi Hái Thiên Lý
...
### `cosmos-furnace` — Đan Lư Càn Khôn
...
### `black-white-mask` — Mặt Nạ Hắc Bạch

**Mô tả**: Mặt nạ chia đôi — trái trắng như tuyết, phải đen như hư vô, ranh giới là một đường kẻ cinnabar đỏ. Đeo vào giữa pháp trận, người chơi phải trả lời: ngươi muốn đan thành bằng con đường nào?

```
/imagine prompt: a split face theatrical mask half ivory white and half ink black divided by a sharp cinnabar red vertical line down the center, each half bearing contrasting element sigils, the mask hovering upright on dark background, intense prismatic rainbow particle storm, shifting iridescent aura, legendary radiance, centered game item icon on dark ink background, [STYLE SUFFIX] --ar 1:1 --stylize 150
```

---

### `dew-inkstone` — Nghiên Mực Sương

**Mô tả**: Nghiên mực đá màu sương sáng sớm, mặt nghiên không khô — mực loang thành vệt linh lực dài ba giây. Đan Sư biết đọc vệt mực sẽ biết linh lực sẽ đi về đâu.
...
### `wind-thunder-fan` — Quạt Phong Lôi
