...
## 1. Main Menu — `UI_WIREFRAMES.md:53`
...
## 3. Lò Editor — `UI_WIREFRAMES.md:123`
...
## 4. Tinh Điểm Tree — `UI_WIREFRAMES.md:176`
...
## 6. Pháp Trận — combat scene (3 phase) — `UI_WIREFRAMES.md:278`
...
## 7. Đan Lư Bàn (Crafting) — `UI_WIREFRAMES.md:371`
...
## 8. Vendor — Lão Hồ Ly — `UI_WIREFRAMES.md:409`
...
## 11. Cheat sheet — Ngũ Hành wheel — `UI_WIREFRAMES.md:500`
...
## 12. Settings — `UI_WIREFRAMES.md:530`
...
## 13. Modal — Phong Ấn / Linh Đan Bể — `UI_WIREFRAMES.md:566`
...
- MJ output ở đây = **mood + nền + ornament**. KHÔNG copy text/số/HUD từ output (MJ viết chữ sai). HUD do Vue + Tailwind dựng theo `UI_WIREFRAMES.md`.
